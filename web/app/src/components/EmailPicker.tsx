        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-slate-100">
                ...
                <div className="p-5 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="mt-2 w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-semibold focus:ring-2 focus:ring-blue-600/20 focus:bg-white transition-all"
                        />
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 px-5 pb-5">
                    {allowClientEmail && onConfirmClientEmail && (
                        <button
                            onClick={onConfirmClientEmail}
                            className="w-full sm:w-auto px-4 py-2.5 text-sm font-bold bg-slate-100 text-slate-700 rounded-xl hover:bg-slate-200"
                        >
                            Dërgo te klienti
                        </button>
                    )}
                    <button
                        ...
                        disabled={!isValid}
                        className="w-full sm:w-auto px-4 py-2.5 text-sm font-bold bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:opacity-50"
                    >
                        Dërgo
                    </button>
                </div>
