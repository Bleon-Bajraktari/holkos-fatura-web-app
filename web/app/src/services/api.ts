...
export const InvoiceService = {
    ...
    bulkEmailViaSmtp: (ids: number[], dest_email: string, company: { smtp_server?: string; smtp_port?: number; smtp_user?: string; smtp_password?: string; name?: string }) =>
        api.post('/send-bulk-email-smtp', { dest_email, document_type: 'invoice', document_ids: ids, smtp_server: company.smtp_server, smtp_port: company.smtp_port, smtp_user: company.smtp_user, smtp_password: company.smtp_password, company_name: company.name }).then(res => res.data),
...
export const OfferService = {
    ...
    bulkEmailViaSmtp: (ids: number[], dest_email: string, company: { smtp_server?: string; smtp_port?: number; smtp_user?: string; smtp_password?: string; name?: string }) =>
        api.post('/send-bulk-email-smtp', { dest_email, document_type: 'offer', document_ids: ids, smtp_server: company.smtp_server, smtp_port: company.smtp_port, smtp_user: company.smtp_user, smtp_password: company.smtp_password, company_name: company.name }).then(res => res.data),
