...
class InvoiceListView(ctk.CTkFrame):
    ...
    def add_invoice_row(self, parent, inv):
        ...
        row_frame.grid_columnconfigure(0, weight=12) # Numri
        row_frame.grid_columnconfigure(1, weight=12) # Data
        row_frame.grid_columnconfigure(2, weight=30) # Klienti
        row_frame.grid_columnconfigure(3, weight=10) # TVSH
        row_frame.grid_columnconfigure(4, weight=16) # Totali
        row_frame.grid_columnconfigure(5, weight=20) # Veprimet
