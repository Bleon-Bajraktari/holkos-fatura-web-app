...
class ClientManagerView(ctk.CTkFrame):
    ...
    def add_client_row(self, client):
        ...
        btn_edit = ctk.CTkButton(
            ...
            hover_color="#E55C00", corner_radius=6, command=lambda c_id=client['id']: self.edit_client(c_id),
            cursor="hand2"
        )
    ...
    def save_client(self):
        ...
        if client.save():
            ...
            messagebox.showinfo("Sukses", "Të dhënat e klientit u ruajtën!")
            self.clear_form()
            self.load_clients()
        else:
            self.btn_save.configure(text=original_text, state="normal")
