...
class InvoiceListView(ctk.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        # Default View
        # self.show_dashboard() # This line is commented out as it's not a method of InvoiceListView
        
        # Hapeni në fullscreen me vonesë dhe update
        # self.update() # This line is commented out as it's not typically used for a CTkFrame in this context
        # self.after(300, lambda: self.state('zoomed')) # This line is commented out as CTkFrame does not have a 'state' method
    ...
    def add_invoice_row(self, parent, inv):
        ...
        # Rregullimi për USB: Kontrollo nëse skedari ekziston lokalisht 
        # edhe nëse rruga absolute në DB është e vjetër
