...
class OfferFormView(ctk.CTkFrame):
    ...
    def add_aligned_row(self, initial_data=None, row_type='item'):
        ...
        if row_type == 'header':
            ...
            if row_type == 'item':
                ...
                right_side_container.grid(row=0, column=2, sticky="ne", padx=10, pady=10)
        ...
        del_row_btn.grid(row=0, column=3, sticky="ne", padx=5, pady=5)
    ...
    def add_module_to_row(self, row_id, label_text="", unit_text=""):
        ...
        mod_id = datetime.now().timestamp() + len(item['modules']) # unique enough
