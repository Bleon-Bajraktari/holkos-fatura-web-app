...
class MainWindow(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.hover_color = "#FF8533" # Pak më e hapur për feedback më të qartë
        self.bg_color = ("#FFFFFF", "#1A1A1A")
        self.sidebar_color = ("#F2F2F2", "#121212")
        
        # UI Scaling (Zoom Out i dukshëm)
        ctk.set_appearance_mode("light")
        ctk.set_default_color_theme("blue")
        ctk.set_widget_scaling(0.8)  # 80% e madhësisë - SHUMË I DUKSHËM
        ctk.set_window_scaling(0.8)  # 80% e dritares
    ...
    def create_sidebar(self):
        ...
        for text, icon, command in nav_info:
            btn = ctk.CTkButton(
                ...
                hover_color=("gray80", "gray25"), # Feedback më i fortë në hover
                anchor="w",
