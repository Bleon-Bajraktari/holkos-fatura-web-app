...
class OfferFormView(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.desc_card.pack(fill="x", padx=30, pady=(15, 15))
        ...
        self.items_card.pack(fill="both", expand=True, padx=30, pady=(0, 15))
        ...
        # 5. Summary (Restored but Simplified)
        ...
        ctk.CTkLabel(totals_inner, text="TOTALI:", font=ctk.CTkFont(family="Inter", size=14, weight="bold"), text_color=self.text_main).grid(row=0, column=0, sticky="w")
        ...
        self.total_label.grid(row=0, column=1, sticky="e", padx=(30, 0))

        # Hidden fields for compatibility
        self.subtotal_label = ctk.CTkLabel(totals_inner, text="") # Placeholder
        self.vat_percentage_entry = ctk.CTkEntry(totals_inner, width=0, height=0); self.vat_percentage_entry.insert(0, "0")
        self.vat_amount_label = ctk.CTkLabel(totals_inner, text="") # Placeholder
        
        # Action Buttons
        actions_frame = ctk.CTkFrame(summary_outer, fg_color="transparent")
        actions_frame.pack(side="left", pady=(10, 0))
    ...
    def calculate_totals(self):
        ...
        # VAT is hidden/zeroed for Offers now as per simplification, essentially Total = Subtotal
    ...
    def get_offer_data(self):
        ...
        # Allow saving even without items if description exists, though UI prompts item add. 
        # But user wants text box predominantly. 
        # If no items, we proceed if description is there.
        ...
        offer.vat_percentage = Decimal("0.00") # No VAT for simplified offers
