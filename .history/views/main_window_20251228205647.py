"""
Dritarja kryesore e aplikacionit - Versioni 1.0.4 (Përmirësuar)
"""
...
class MainWindow(ctk.CTk):
    def __init__(self):
        ...
        # 1. Konfigurimi fillestar
        self.title("Holkos Fatura - v1.0.4")
        self.geometry("1200x800")
        
        # 2. UI Scaling - E bëjmë 0.8 që të nxjerrë gjithçka në pah
        ...
        # DHUNA për Fullscreen (Maximized)
        # E bëjmë pas një kohe të mjaftueshme
        self.after(100, self.make_maximized)

    def make_maximized(self):
        """Metoda më e sigurt për Maximized në Windows"""
        try:
            self.state('zoomed')
        except:
            # Plan B: Nëse dështon 'zoomed', kap madhësinë e ekranit
    ...
    def create_sidebar(self):
        ...
        ctk.CTkLabel(self.sidebar, text="v1.0.4 Premium", font=ctk.CTkFont(size=10), text_color="gray").pack(side="bottom", pady=20)
