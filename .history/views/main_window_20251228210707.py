"""
Dritarja kryesore - v1.0.6 (Rikthimi i Cilësimeve dhe Fix për Logo)
"""
...
class MainWindow(ctk.CTk):
    def __init__(self):
        ...
        self.title("Holkos Fatura - v1.0.6")
        ...
        # Forcimi i fullscreen
        self.after(300, self.force_maximize)
    ...
    def create_sidebar(self):
        ...
        self.nav_buttons = {}
        # RIKTHIMI I CILËSIMEVE (U harrua në v1.0.5)
        nav_info = [
        ...
        ctk.CTkLabel(self.sidebar, text="v1.0.6 Premium", font=ctk.CTkFont(size=10), text_color="gray").pack(side="bottom", pady=20)
    ...
    def show_settings(self):
        ...
        settings.grab_set()
        # Kjo hapet si dritare modal, kështu që nuk ndryshojmë stilin e navigimit
