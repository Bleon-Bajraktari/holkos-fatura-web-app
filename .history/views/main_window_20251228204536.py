...
class MainWindow(ctk.CTk):
    ...
    def __init__(self):
        ...
        # UI Scaling (Zoom Out) - kjo ndihmon në ekrane më të vegjël
        ctk.set_appearance_mode("light")
        ctk.set_default_color_theme("blue")
        ctk.set_widget_scaling(0.85)  # Zoom out widget-et (85%)
        ctk.set_window_scaling(0.85)  # Zoom out dritaren (85%)
        ...
        # Hapeni në fullscreen me vonesë të vogël
