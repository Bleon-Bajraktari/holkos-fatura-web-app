...
class OfferListView(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Kolonat: Numri, Data, Klienti, Subjekti, Totali, Veprimet
        header_cols = [("NUMRI", 12), ("DATA", 12), ("KLIENTI", 25), ("SUBJEKTI", 20), ("TOTALI", 16), ("VEPRIMET", 15)]
    ...
    def load_offers(self):
        ...
        groups = {}
        for off in offers:
            cname = off.get('client_name', 'Pa Emër').strip()
    ...
    def add_client_group(self, client_name, offers):
        ...
        total_sum = sum(float(off['total']) for off in offers)
    ...
    def add_offer_row(self, parent, off):
        ...
        client_name = off.get('client_name', '').strip()
        ...
        subject = off.get('subject', '').strip()
        if len(subject) > 25: subject = subject[:22] + "..."
