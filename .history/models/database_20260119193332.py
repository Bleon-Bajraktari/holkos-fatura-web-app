...
class Database:
    ...
    def connect(self, force=False):
        ...
        # Mos provo lidhjen më shpesh se çdo 30 sekonda nëse të dyja kanë dështuar
        if not force and Database._cloud_conn is None and Database._backup_conn is None:
            if current_time - Database._last_attempt_time < 30:
                return False
    ...
    def check_connection_status(cls):
        ...
        if cls._cloud_conn:
            ...
            current_time = time.time()
            if current_time - cls._last_attempt_time < 30:
                return False
