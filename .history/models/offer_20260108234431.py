...
class Offer:
    ...
    def add_item(self, description, unit, quantity, unit_price, custom_attributes=None):
    ...
    def save(self):
        ...
        try:
            ...
            if self.id:
                ...
                if self.items:
                    item_query = """
                        INSERT INTO offer_items (offer_id, description, unit, quantity, unit_price, subtotal, custom_attributes, order_index)
