...
class DatabaseConfig:
    ...
    def __init__(self):
        # KONFIGURIMI LOKAL (XAMPP) - E rekomanduar për shpejtësi dhe stabilitet
        self.host = "localhost"
        self.port = 3306
        ...
        # KONFIGURIMI ONLINE (InfinityFree zakonisht NUK lejon lidhje nga jashtë)
        # self.host = "sql112.infinityfree.com"
        # self.port = 3306
        # self.database = "if0_40934720_holkos"
        # self.user = "if0_40934720"
        # self.password = "OxdBMSINTJ"
