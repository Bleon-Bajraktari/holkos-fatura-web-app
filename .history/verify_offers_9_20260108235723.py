...
def verify():
    print("Verifikimi i Ofertës me Formula Horizontale...")
    db = Database()
    db.connect()
    ...
    offer.subject = "Oferte me Formula Horizontale"
    
    # Item 1: Multiple modules (Formula display)
    custom_mods_1 = [
        {'value': '12.5', 'unit': 'm2'},
        {'value': '20.00', 'unit': '€'}
    ]
    offer.add_item("Dritare PVC - Formula Line", "", 1, 250.00, custom_mods_1, 'item')
