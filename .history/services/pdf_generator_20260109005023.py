...
class PDFGenerator:
    ...
    def generate_offer(self, offer: Offer, output_path=None, manual_font_size=None):
        ...
        if offer.items:
            ...
            # Select font based on density
            if count < 7 and total_len < 400:
            ...
            for item in offer.items:
                ...
                if desc_text and formula_html:
                    story.append(Paragraph(f"{desc_text} <font color='#666666'>=</font> {formula_html}", r_style))
                elif desc_text:
