...
class PDFGenerator:
    ...
    def generate(self, invoice: Invoice, output_path=None):
        ...
        if float(invoice.vat_amount) == 0:
            note_text = "<i>Ngarkesa e kundert, nenparagrafi 1.4.1 ose 1.4.2 i nenit 52 te ligjit per TVSH</i>"
            
        totals = [
            [Paragraph(note_text, self.note_style) if note_text else "", "TOTAL PA TVSH", self.format_number(invoice.subtotal, with_currency=True)],
        ...
        # Gjerësitë: [Shënimi(L), Etiketa(R), Shuma(R)]
        # Përshtatet me ndryshimet lart: Kolona e fundit 40mm
        ...
        totals_table.setStyle(TableStyle([
            ...
            ("ALIGN", (0, 0), (0, -1), "LEFT"),
            ("ALIGN", (1, 0), (2, -1), "RIGHT"),
            ("VALIGN", (0, 0), (-1, -1), "MIDDLE"), # Center vertical align
            ("SPAN", (0, 0), (0, 3)), # Shënimi shtrihet në të gjitha rreshtat e totalit
            ("FONTSIZE", (1, 0), (1, -1), 10),
            ...
            # Specikfikisht për rreshtin e fundit (PER PAGESE)
            ("VALIGN", (0, 3), (-1, 3), "MIDDLE"), 
            ("BOTTOMPADDING", (0, 3), (-1, 3), 8), # Pak më shumë hapësirë poshtë për ta ngritur tekstin vizualisht në raport me kornizën
