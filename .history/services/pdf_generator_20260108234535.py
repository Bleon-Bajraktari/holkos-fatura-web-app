    ...
    def generate_offer(self, offer: Offer, output_path=None):
        ...
        if offer.items:
            ...
            for item in offer.items:
                ...
                # We render the custom_attributes as a vertical list of pills/lines
                right_flowables = []
                ...
                if custom_attr and isinstance(custom_attr, list):
                    ...
                    # If we have a subtotal (calculated in UI or stored), show it as Total
            ...
            t = Table(main_table_data, colWidths=[130*mm, 60*mm])
            t.setStyle(TableStyle([
                ...
                ("BOTTOMPADDING", (0, 0), (-1, -1), 12), # Space between rows
            ]))
            story.append(t)
