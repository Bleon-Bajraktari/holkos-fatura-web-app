...
class PDFGenerator:
    ...
    def generate_offer(self, offer: Offer, output_path=None, manual_font_size=None):
        ...
        if offer.items:
            ...
            # Specialized Styles (Perfectly Aligned)
            ...
            r_header = ParagraphStyle("RHead", parent=self.normal_style, fontSize=base_font+3, leading=leading+4, fontName="Helvetica-Bold", textColor=colors.black, leftIndent=0, firstLineIndent=0)
            ...
            for item in offer.items:
                ...
                calc_segments = []
                # Parse custom_attributes for border and modules
                custom_attr_raw = item.get('custom_attributes', [])
                modules_list = []
                has_border = True # Default to True as per requirements
                ...
                if desc_text and formula_html:
                    ...
                    # Use table even for just text to maintain EXACT same column coordinate as items with formula
