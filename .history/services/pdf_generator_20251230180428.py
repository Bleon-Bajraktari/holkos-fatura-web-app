...
class PDFGenerator:
    ...
    def generate(self, invoice: Invoice, output_path=None):
        ...
        totals_table.setStyle(TableStyle([
            ...
            ("ALIGN", (0, 0), (-1, -1), "RIGHT"),
            ("FONTSIZE", (0, 0), (0, -1), 10), # Font fiks 10 për etiketat
            ("FONTNAME", (0, 3), (-1, 3), "Helvetica-Bold"),
            ("FONTNAME", (1, 3), (1, 3), "Helvetica-Bold"),
            ("FONTSIZE", (1, 3), (1, 3), 13), # Totali final rritur
        ...
        # SHËNIMI PËR TVSH 0% (Reverse Charge)
        if float(invoice.vat_amount) == 0:
            ...
            story.append(Paragraph(note_text, self.note_style))
            
        story.append(Spacer(1, 40*mm))  # Rritur nga 30mm
